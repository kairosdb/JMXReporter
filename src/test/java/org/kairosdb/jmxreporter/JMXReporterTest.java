...
class JMXReporterTest
{
	...
	@Test
	void testBeanRegistration() throws InstanceNotFoundException, MalformedObjectNameException, NotCompliantMBeanException, InstanceAlreadyExistsException, MBeanRegistrationException, ListenerNotFoundException
	{
	...
	@Test
	void testCompositBeanRegistration() throws InstanceNotFoundException, MalformedObjectNameException, NotCompliantMBeanException, InstanceAlreadyExistsException, MBeanRegistrationException, ListenerNotFoundException
	{
		MBeanServer server = ManagementFactory.getPlatformMBeanServer();
		...
		Map<String, String> expectedTags = new HashMap<>();
		expectedTags.put("type", "TestComposite");
